...
void InitPCA_COPM(void)
{
	...
	PCA_CH0_SetMode_COPM();			// 设置CH0 为16位高速输出模式
	PCA_CH2_SetMode_COPM();			// 设置CH2 为16位高速输出模式
	...
	// 设置PWM输出引脚
	PCA_SetCEX0CEX2CEX4_P22P24P26();			// 设置CEX0:P22,CEX2:P24,CEX4:P17
