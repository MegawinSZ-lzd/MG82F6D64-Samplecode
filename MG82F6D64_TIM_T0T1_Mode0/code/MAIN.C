/*********************************************************************
	...
	功能描述：
			定义T0为8位定时器,8位PWM输出到P34,频率为为Sysclk/192/256=651Hz 	
			定义T1为8位定时器,8位PWM输出到P35,频率为为Sysclk/48/256=2.604KHz  
			*注意: 占空比无法做到100%,需要软件上处理
	注意事项：
...
void InitTimer0(void)
{
	...
	TM_SetT0CKO_P34();						// 设置T0CKO为 P34
	TM_EnT0CKO();							// 使能T0CKO 输出	
	TM_EnableT0();							// 使能T0
}
...
void InitTimer1(void)
{
	...
	TM_SetT1CKO_P35();						// 设置T1CKO为 P35
	TM_EnT1CKO();							// 使能T1CKO 输出
	TM_EnableT1();							// 使能T1
}
