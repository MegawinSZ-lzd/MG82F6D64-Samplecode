...
void InitPCA(void)
{
	PCA_SetCLOCK_SYSCLKdiv12();						// PCA时钟为SysClk/12 = 12MHz/12=1MHz
	
	PCA_CH0_SetMode_16BitSoftwareTimer();			// 设置CH0 为16位软件定时器
	PCA_CH2_SetMode_16BitSoftwareTimer();			// 设置CH2 为16位软件定时器
