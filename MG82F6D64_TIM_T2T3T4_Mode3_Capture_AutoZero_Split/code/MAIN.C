/*********************************************************************
    项目名称:MG82F6D64-DEMO
		...
		功能描述：
			定义T2为Mode3:捕获模式自动清零,分割模式
			定义T3为Mode3:捕获模式自动清零,分割模式
			定义T4为Mode3:捕获模式自动清零,分割模式
		注意事项：
...
{
	TM_SetT2Mode_CapturewithAutoZero();		// 设置T2模式2为位捕获模式 自动清零
...
{
	TM_SetT3Mode_CapturewithAutoZero();		// 设置T3模式3为捕获模式 自动清零
...
{
	TM_SetT4Mode_CapturewithAutoZero();		// 设置T4模式2为捕获模式 自动清零
