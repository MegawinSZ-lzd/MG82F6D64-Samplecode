/*********************************************************************
    项目名称:MG82F6D64-DEMO
		...
		功能描述：
			定义T2为Mode6:DutyCapture模式 分割模式
			定义T3为Mode6:DutyCapture模式 分割模式
			定义T3为Mode6:DutyCapture模式 分割模式
...
void InitTimer2(void)
{
	...
	TM_DisableTR2LC();								// 禁用TR2LC以防止EXF2清除TR2L
...
void InitTimer3(void)
{
	...
	TM_DisableTR3LC();								// 禁用TR3LC以防止EXF3清除TR3L
...
void InitTimer4(void)
{
	...
	TM_DisableTR4LC();								// 禁用TR4LC以防止EXF4清除TR4L
